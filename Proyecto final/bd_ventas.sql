CREATE DATABASE  IF NOT EXISTS `bd_ventas` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bd_ventas`;
...
INSERT INTO `cliente` VALUES (17,'98695692','Juan Guerrero Solis','Los Alamos','1'),(18,'1','Maria Rosas Villanueva','Los Laureles 234','1'),(19,'3','Andres de Santa Cruz','Av. La Frontera 347','1'),(20,'4','Andres Mendoza','Chosica, Lurigancho','1');
...
INSERT INTO `detalle_ventas` VALUES (1,1,1,1,150),(2,2,1,1,150),(3,3,1,1,150);
...
INSERT INTO `empleado` VALUES (1,'123','Pedro Hernandez','988252459','1','emp01'),(2,'123','Roman Riquelme','988252459','1','Jo46'),(3,'123','Palermo Suarez','453536458','1','Em22'),(4,'123','Juan Perez','987684812','1','jcc37'),(7,'123','Asa de','4234444','1','jd34'),(8,'42796402','Jak camones','968574812','1','jk01');
...
INSERT INTO `producto` VALUES (1,'Teclado Logitech 345',150,96,'1'),(2,'Mouse Logitech 567',20,98,'1'),(3,'Laptop Lenovo Ideapad 520',800,100,'1'),(4,'HeadPhones Sony M333',500,98,'1');
...
INSERT INTO `ventas` VALUES (1,18,2,'000000001','2019-06-14',150,'1'),(2,18,2,'000000002','2019-06-14',150,'1'),(3,18,2,'000000003','2019-06-14',150,'1');
...
-- Dump completed on 2020-12-07 17:57:53
